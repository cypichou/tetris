...
public class TPieceTest {
    ...
    public void testCoordonnees() {
        ...
        TPiece piece = new TPiece(new Coordonnees(0, 0), Couleur.ROUGE);
        ...
        assertEquals(elements.get(2).getCoordonnees(), new Coordonnees(1, 0));
        assertEquals(elements.get(3).getCoordonnees(), new Coordonnees(0, 1));
    ...
    public void testDeplacement() {
        ...
        TPiece piece = new TPiece(new Coordonnees(3, 4), Couleur.ROUGE);
    ...
    public void toStringTest() {
        ...
        TPiece tPiece = new TPiece(c, ref);

        String expectedString = "TPiece :\n" + "    (0, 0) - CYAN\n" + "    (-1, 0) - CYAN\n" + "    (1, 0) - CYAN\n"
                + "    (0, 1) - CYAN\n";
        assertEquals(expectedString, tPiece.toString());
    }
    ...
    public void tournerTest() throws BloxException {
        ...
        assertEquals(tPiece.getElements().get(1).getCoordonnees(), pun);
    }
